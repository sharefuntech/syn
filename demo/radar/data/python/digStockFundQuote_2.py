...
def readAllFundQuote():
	...
	for fund in fundList:
		...
		print 'check in fund: ', fundName
		# 抓取单个基金业绩
		getSingleFundQuote(fundCode, fundName)
	csvReader.close()
	# finish digging
	print 'succesfully dig all quote!'
# ---------------------------------------------------------------
...
def setupConnection(fundCode, driverMode):
	...
	time.sleep(3)
	print 'succesfully connected: ', fundCode
