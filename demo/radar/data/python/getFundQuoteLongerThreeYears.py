...
def getSingleFundQuote(fundCategary, fundCode, fundName):
	try:
		...
		# 	print 'established year less than 3 years, drop this fund!'
		# 	return
		for x in range(totalPageNumber):
			scrapQuote(fundCategary, pageConnection, fundCode, fundName)
...
# ------scrapQuote() 抓取单个页面数据==============================
def scrapQuote(pageConnection, fundCategary, fundCode, fundName):
	try:
		#提取单页数据
