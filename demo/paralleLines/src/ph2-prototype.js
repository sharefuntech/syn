    ...
    .await(function(error, listProvinceCity, dataProvince, dataCity) {
        ...
        function drawGraph() {
            ...
            function filterParalleledDataBySelectedPlace(selectedStatus, parallelConfig) {
                ...
                // 设置动画参数
                if (selectedPlace.size() == 1) {
                    vm.$data.graphConfig.enableAnimation = true;
                    // graphConfig.enableAnimation = true;
                } else {
                    vm.$data.graphConfig.enableAnimation = false;
                    // graphConfig.enableAnimation = false;
                }
